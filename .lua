...
local LunoraHub = {}
LunoraHub.Config = {
    WindowName = "Quantum Hub",
    WindowSubtitle = "by @Kaido",
    WindowWidth = 450,
    WindowHeight = 300,
    TabWidth = 135,
...
CloseOpenButton.BorderColor3 = LunoraHub.Config.PrimaryColor
CloseOpenButton.Position = UDim2.new(0.1021, 0, 0.0743, 0)
CloseOpenButton.Size = UDim2.new(0, 48, 0, 48)
CloseOpenButton.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=105064375011290"
...
UIStrokeButton.Color = LunoraHub.Config.PrimaryColor
...
LogoContainer.Position = UDim2.new(0, 8, 0, 9)
LogoContainer.BackgroundTransparency = 1 -- TRANSPARENT
...
LogoImage.BackgroundTransparency = 1 -- TRANSPARENT BACKGROUND
LogoImage.Size = UDim2.new(1, 0, 1, 0)
LogoImage.Image = LunoraHub.Config.LogoImage
LogoImage.ImageColor3 = Color3.fromRGB(255, 255, 255) -- WHITE COLOR
...
-- Optional: Border stroke for logo
local LogoBorder = Instance.new("UIStroke")
LogoBorder.Color = LunoraHub.Config.PrimaryColor
LogoBorder.Thickness = 1
LogoBorder.Transparency = 0.4
LogoBorder.Parent = LogoImage

-- Title (Bangers Font) - Adjusted position for logo
...
TabContainer.Size = UDim2.new(1, -15, 1, -135)
TabContainer.Position = UDim2.new(0, 8, 0, 72)
...
DiscordLabel.Text = "Quantum Hub X"
...
-- Button Creation Function (Bangers Font)
...
function LunoraHub:CreateToggle(parent, text, defaultValue, description, callback)
...
print("✨ Quantum Hub X - Loaded Successfully ✨")
return LunoraHub
